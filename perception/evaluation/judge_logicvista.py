...
Question: Which choice completes the pattern?\n
Model response: The missing shape follows option C.\n
...
Question: Which two options follow the rule?\n
Model response: The correct answers are B and D.\n
Extracted answer: <answer>B, D</answer>
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="LogicVista API Judge ArgParser")
...
def read_logicvista_eval_data(filepaths: list[str]):
    all_data = []
...
def main(args):
    ...
    data_for_judge = read_logicvista_eval_data(filepaths=filepaths)
