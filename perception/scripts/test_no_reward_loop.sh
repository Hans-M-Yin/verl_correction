...
VLLM_USE_V1=1 python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=../data/preprocessed_dataset/dataset1_virl_38k_20260112_185847/train.parquet \
    data.val_files=../data/preprocessed_dataset/dataset1_virl_38k_20260112_185847/test.parquet \
    ...
    reward_model.model.path=/root/autodl-tmp/qwen3-vl-30b \
    ...
    reward_model.rollout.prompt_length=4000 \
