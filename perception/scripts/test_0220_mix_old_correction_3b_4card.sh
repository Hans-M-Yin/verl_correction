...
ENGINE=${1:-vllm}
# Run on 901b2136
# 还是用老的Correction reward，去掉acc条件试试？反正现在correction的条件严苛，不一定会导致repetition，相较于0218，repetition_threhold从0.95降低到0.7，
# 这一次去掉了acc条件，别的同test0219_mix_old_correction
VLLM_USE_V1=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='0220_qwen2_5_vl_3b_mix_10k_old_correction_REAL' \
    ...
    trainer.validation_data_dir=./rollouts_saved/0220_mix_data_3b_old_correction_REAL/val/ \
    trainer.rollout_data_dir=./rollouts_saved/0220_mix_data_3b_old_correction_REAL/train/ \
