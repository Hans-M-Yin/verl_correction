...
VLLM_USE_V1=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='0304_qwen2_5_vl_7b_mix_10K_no_kl_n8' \
    trainer.val_before_train=False \
    trainer.n_gpus_per_node=4 \
    trainer.nnodes=1 \
    trainer.save_freq=85 \
    trainer.test_freq=5 \
    ...
    trainer.validation_data_dir=./rollouts_saved/test_0304_mix_data_7b_no_kl_n8/val/ \
    trainer.rollout_data_dir=./rollouts_saved/test_0304_mix_data_7b_no_kl_n8/train/ \
