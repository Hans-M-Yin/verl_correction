...
# 注意！！！忘记去掉acc条件了。所以实验只修改了KL系数和repetition_threshold
VLLM_USE_V1=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='0219_qwen2_5_vl_3b_mix_10k_old_correction' \
    ...
    trainer.validation_data_dir=./rollouts_saved/0219_mix_data_3b_old_correction/val/ \
    trainer.rollout_data_dir=./rollouts_saved/0219_mix_data_3b_old_correction/train/ \
