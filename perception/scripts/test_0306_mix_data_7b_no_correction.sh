...
VLLM_USE_V1=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='0306_qwen2_5_vl_7b_mix_10K_no_correction_n8' \
    ...
    +trainer.trigger_start_ratio=0.6 \
    ...
    trainer.validation_data_dir=./rollouts_saved/test_0306_mix_data_7b_no_correction_n8/val/ \
    trainer.rollout_data_dir=./rollouts_saved/test_0306_mix_data_7b_no_correction_n8/train/ \
